...
print(("Passed" if abs(actual - expected) / actual < epsilon else "*FAILED*") + " test 1")
...
print(("Passed" if abs(actual - expected) / actual < epsilon else "*FAILED*") + " test 2")
...
print(("Passed" if abs(actual - expected) / actual < epsilon else "*FAILED*") + " test 3")
...
print(("Passed" if abs(actual - expected) / actual < epsilon else "*FAILED*") + " test 4")
...
actual = bp.dsdot(n, np.ctypeslib.as_ctypes(mat3), True, 1, np.ctypeslib.as_ctypes(mat4), True, 1)
expected = np.dot(mat1, mat2)[0][0]
print(("Passed" if abs(actual - expected) / actual < epsilon else "*FAILED*") + " test 5")
...
expected = np.dot(mat1, mat2)[0][0]
print(("Passed" if abs(actual - expected) / actual < epsilon else "*FAILED*") + " test 6")