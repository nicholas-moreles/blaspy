...
class TestSdot(TestCase):
    ...
    def test_vectors_as_matrices(self):
        ...
        y = asmatrix(array([[3., 2., 1.]], dtype='float32'))
        self.assertEqual(sdot(x, y), 10)
    ...
    def test_float32_output(self):
        x = array([[1., 2., 3.]], dtype='float32')
        y = array([[3., 2., 1.]], dtype='float32')
        self.assertEqual(sdot(x, y, output='float32'), 10)
    ...
    def test_not_numpy_with_list_for_x_raises_ValueError(self):
        x = [[1., 2., 3.]]
        y = array([[3., 2., 1.]])
        self.assertRaises(ValueError, sdot, x, y)
    ...
    def test_not_2d_numpy_with_3d_for_x_raises_ValueError(self):
        x = array([[[1.], [2.], [3.]]], ndmin=3, dtype='float32')
        y = array([[3., 2., 1.]], dtype='float32')
        self.assertRaises(ValueError, sdot, x, y)

    def test_not_2d_numpy_with_3d_for_y_raises_ValueError(self):
        x = array([[1., 2., 3.]], dtype='float32')
        y = array([[[3.], [2.], [1.]]], ndmin=3, dtype='float32')
        self.assertRaises(ValueError, sdot, x, y)
    ...
    def test_unequal_vector_length_raises_ValueError(self):
        x = array([[1., 2., 3.]], dtype='float32')
        y = array([[3., 2.]], dtype='float32')
        self.assertRaises(ValueError, sdot, x, y)

    def test_unequal_vector_length_with_strides_raises_ValueError(self):
        x = array([[1., 2., 3.]], dtype='float32')
        y = array([[3., 2., 1.]], dtype='float32')
        self.assertRaises(ValueError, sdot, x, y, 2, 3)

    def test_float64_dtype_for_both_raises_ValueError(self):
    ...
    def test_float64_dtype_for_x_raises_ValueError(self):
        x = array([[1., 2., 3.]], dtype='float64')
        y = array([[3., 2., 1.]], dtype='float32')
        self.assertEqual(x.dtype, 'float64')
    ...
    def test_float64_dtype_for_y_raises_ValueError(self):
        x = array([[1., 2., 3.]], dtype='float32')
        y = array([[3., 2., 1.]], dtype='float64')
