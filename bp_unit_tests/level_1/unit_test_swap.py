"""
    ...
    swapright (c) 2014, The University of Texas at Austin.
    All rights reserved.
...
class TestSwap(TestCase):
    ...
    def test_strides_greater_than_length(self):
        ...
        expected_x = [[4., 2., 3.]]
        expected_y = [[1., 5., 6.]]
        self.assertListEqual(swap(x, y, inc_x=3, inc_y=3).tolist(), expected_y)
        self.assertListEqual(x.tolist(), expected_x)
        self.assertListEqual(y.tolist(), expected_y)
    ...
    def test_not_numpy_with_list_for_x_raises_ValueError(self):
        x = [[1., 2., 3.]]
        y = array([[3., 2., 1.]])
        self.assertRaises(ValueError, swap , x, y)
    ...
    def test_unequal_vector_length_with_strides_raises_ValueError(self):
        x = array([[1., 2., 3.]])
        y = array([[3., 2.]])
        self.assertRaises(ValueError, swap, x, y, 2, 3)
